...
dependencies {
     // NeoForge
     implementation group: 'net.darkhax.resourcetrimmer', name: 'resourcetrimmer-neoforge-26.1.2', version: '26.1.2.0'
     // Fabric
     implementation group: 'net.darkhax.resourcetrimmer', name: 'resourcetrimmer-fabric-26.1.2', version: '26.1.2.0'
     // Common / MultiLoader / Vanilla / No Loader
     implementation group: 'net.darkhax.resourcetrimmer', name: 'resourcetrimmer-common-26.1.2', version: '26.1.2.0'
}
```
